...
<body>
	<header>
		...
		<ul id="slide-out" class="sidenav sidenav-fixed" style="padding-top: 50px">
			...
			<li><a href="<?= base_url('peminjaman/waiting_approval') ?>"><i class="material-icons">thumb_up</i>Menunggu Approval</a></li>
			...
			<li><a href="<?= base_url('peminjaman/rejected/') ?>"><i class="material-icons">close</i>Peminjaman Ditolak</a></li>
